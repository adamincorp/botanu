...
wait = {
    ...
    'timeline':True,
    'autoAdd':False,
    'message':"Suwun sampun add",
    "lang":"JP",
    "comment":"Suwun samoun add",
    "commentOn":False,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
...
#-----------------------------------------------
       ...
       #-------------Fungsi Respon Start---------------------#
                ...
                cl.sendText(msg.to,"Santai wae lurrr")
                ki.sendText(msg.to,"Ojo kuwatir")
                kk.sendText(msg.to,"Pokoke sabar")
                kc.sendText(msg.to,"Tinggal ngopi sek")
