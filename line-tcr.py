...
cl = LINETCR.LINE()
cl.login(token="ElKpE5k4GhPtzV7ZK7Gb.dH0W+ZwoG+SgA/L22XR4AW.NEFFVsIkBGRk/EKDQqRe/UxOw4jmO/0FTpIhfjj87EQ=")

ki = LINETCR.LINE()
ki.login(token="El5qTspUjxkRUiPcyCHf.Oq8Kre5TQg9wThWxTX8yhW.j4fG35pV/+2Lw5tK+6eJOkv3eiT1g/N4f+tkwKgo92g=")

kk = LINETCR.LINE()
kk.login(token="El3mmw0WOEGZUld4IFJf.6W0k4m5LY4Dp+U0xnEZTJW.X/ED8KCv1hDKgndDIW0Jyf8y5VgiOpTmo4+CFM5qq34=")

kc = LINETCR.LINE()
kc.login(token="ElRZAOluBENG2tNowj10.cmlDELtx2hgkAcFskVZ7Wa.SBEYf3SvwsADSH+w2uVaYNrPoScFcucXK//s6cstwEw=")
...
helpMessage =""" [PeKI] BOT Menu V.2  􀔃􀄆red check mark􏿿
...
Bots=[mid,Amid,Bmid,Cmid,"u08c2dd7a54d7d8718a6827d22afcfbc0"]
