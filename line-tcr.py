...
admin=["u08c2dd7a54d7d8718a6827d22afcfbc0"]
wait = {
    'contact':True,
    'autoJoin':True,
    ...
    try:
            ...
            if msg.contentType == 13:
               if wait["wblack"] == True:
                ...
                if msg.toType == 2:
                    ...
                    cl.updateGroup(X)
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Invite by link on")
                    else:
        ...
        #-------------Fungsi Jam on/off Start-------------------#            
                ...
                if wait["clock"] == True:
                    ...
                    ki.sendText(msg.to,"Bot 2 jam on")
                    ...
                    kk.sendText(msg.to,"Jam Selalu On")
            elif msg.text in ["Jam off"]:
                if wait["clock"] == False:
                    cl.sendText(msg.to,"Bot 1 jam off")
                    kk.sendText(msg.to,"Bot 2 jam off")
                else:
                    wait["clock"] = False
                    cl.sendText(msg.to,"Jam Sedang Off")
                    kk.sendText(msg.to,"Jam Sedang Off")
         ...
         #-------------Fungsi Jam Update Start---------------------#            
                ...
                if wait["clock"] == True:
                    ...
                    profile.displayName = wait["cName"] + nowT
                    cl.updateProfile(profile)
                    cl.sendText(msg.to,"Sukses Update Jam")
                    ...
                    profile2.displayName = wait["cName2"] + nowT
                    kk.updateProfile(profile2)
                    kk.sendText(msg.to,"Sukses Update Jam")
                else:
                    cl.sendText(msg.to,"Please turn on the name clock")
                    kk.sendText(msg.to,"Please turn on the name clock")
                       ...
                       if targets == []:
                           ...
                           for target in targets:
                                try:
                                    ...
                                    ki.sendText(msg.to,"Sepurane lurr")
                                    kc.sendText(msg.to,"boten sengojo")
...
#-----------------------------------------------
       ...
       #-------------Fungsi Respon Start---------------------#
            elif msg.text in ["Respon","respon","Poro sedulur","respon dong"]:
                cl.sendText(msg.to,"Nggeh")
                ki.sendText(msg.to,"pripun")
                kk.sendText(msg.to,"Sendiko dawuh")
